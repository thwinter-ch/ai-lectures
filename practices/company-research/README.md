...
Öffne [prompts/01-deep-research.md](./prompts/01-deep-research.md) und kopiere den Prompt. Ersetze die drei Platzhalter (`[COMPANY NAME]`, `[INDUSTRY]`, `[COUNTRY/REGION]`) mit deinem Zielunternehmen.
...
3. Füge den Prompt aus [prompts/02-strategy-synthesis.md](./prompts/02-strategy-synthesis.md) darunter ein
...
| File | Purpose |
|------|---------|
| [prompts/01-deep-research.md](./prompts/01-deep-research.md) | Deep research prompt (English, Swiss German output) |
| [prompts/02-strategy-synthesis.md](./prompts/02-strategy-synthesis.md) | Golden Circle + BMC + VPC synthesis |
