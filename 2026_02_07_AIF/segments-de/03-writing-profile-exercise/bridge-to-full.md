# Brücke zum vollständigen Profil

Sie haben das LITE-Interview abgeschlossen (10 Fragen, ~15 Minuten). Das vollständige Geschmacksinterview umfasst 100 Fragen in sieben Kategorien -- die LITE-Version hat jeweils eine oder zwei daraus entnommen. Diese Brücke setzt dort an, wo Sie aufgehört haben, und fügt die verbleibenden ~90 Fragen hinzu, ohne bereits Beantwortetes zu wiederholen.

**Ist der zusätzliche Zeitaufwand gerechtfertigt?** Nur wenn Ihr Schreiben je nach Kontext erheblich variiert, Sie eine tiefe Abdeckung von Randfällen wünschen oder Sie ein Profil für hochriskante/hochvolumige Nutzung aufbauen. Andernfalls erfasst die LITE-Version das Kernsignal.

---

## Der Brücken-Prompt

Kopieren Sie alles unten und fügen Sie es in eine neue Konversation ein (oder setzen Sie Ihre LITE-Sitzung fort):
...
## Wann Sie diese Version verwenden sollten

| Szenario | LITE verwenden | Vollständig verwenden |
|----------|----------------|----------------------|
| Gelegentliche persönliche Nutzung | Ja | Nein |
| Aufbau eines Einzweck-Schreibassistenten | Ja | Nein |
| Hochvolumige Inhaltsproduktion (wöchentlich+) | Nein | Ja |
| Multi-Format-Bedürfnisse (Tweets, Artikel, E-Mails, Proposals) | Nein | Ja |
| Ihr Schreiben variiert erheblich je nach Zielgruppe | Nein | Ja |
| Training eines Teams oder Dienstleisters zur Stimmanpassung | Nein | Ja |
| Aufbau einer öffentlichen AI-Persona | Nein | Ja |
| Erfassung von Randfällen und Ausnahmebehandlung | Nein | Ja |

**Der Kompromiss:** LITE dauert 15-20 Minuten und erfasst 60-70% des Signals. Vollständig dauert 90-120 Minuten und erfasst 90-95%. Abnehmende Erträge setzen ein, aber für hochriskante Nutzung ist die zusätzliche Abdeckung wichtig.

---

## Tipps für die erweiterte Sitzung

1. **Machen Sie Pausen.** Das vollständige Interview funktioniert besser als 2-3 Sitzungen als ein zweistündiger Marathon.

2. **Halten Sie Ihre LITE-Antworten sichtbar.** Beziehen Sie sich darauf, wenn Sie konsistent bleiben müssen oder sich bewusst widersprechen möchten.

3. **Seien Sie spezifisch.** Vage Antworten in der LITE-Version sind in Ordnung -- Sie arbeiten schnell. In der erweiterten Version zwingen Sie sich, konkrete Beispiele zu geben.

4. **Achten Sie auf Ermüdung.** Ihre späteren Antworten werden schlechter, wenn Sie ausgebrannt sind. Besser pausieren und fortsetzen, als es nur abzuspulen.

5. **Vertrauen Sie den Widersprüchen.** Echte Stimmen sind nicht perfekt konsistent. Wenn Sie etwas sagen, das einer früheren Antwort widerspricht, sind das Daten, kein Problem.
